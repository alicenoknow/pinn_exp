...
class SimpleDomain(Domain):
    ...
    def _generate_linespaces(self, n_points: int = None, requires_grad=False):
        x_domain, y_domain = self.params.XY_DOMAIN, self.params.XY_DOMAIN
        t_domain = self.params.T_DOMAIN
        xy_points, t_points = self.params.INTERIOR_POINTS, self.params.T_POINTS
